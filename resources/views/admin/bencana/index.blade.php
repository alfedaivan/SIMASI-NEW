        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body ">
                        @role('pusdalop')
                        <a href="{{ route('bencana.create') }}" class="btn btn-success mb-2 ">
                            <!-- data-toggle="modal" data-target="#tambah" style="font-size: 14px;" -->
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-lg" role="menu">
                                                <a href="{{ route('bencana.edit', $bencana->idBencana) }}" class="dropdown-item " title="Edit Bencana">
