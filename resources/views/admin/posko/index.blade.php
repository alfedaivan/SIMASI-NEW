                                    ...
                                    <form action="{{ route('posko.create') }}" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="idPosko"
                                                    name="idPosko" value="{{request()->id}}" hidden required>
                                            </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody id="result">
                                ...
                                <tr>
                                    ...
                                    {{ $ttl->ttlPengungsi}}
                                    @endforeach -->
                                        <a href="{{url('/listPengungsi')}}/<?php echo $posko->idPosko; ?>"
                                            class="btn btn-primary btn-xs"><i class="fas fa-eye"></i> Pengungsi </a>
                                    </td>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{$detail->namaPosko}}" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="trc">TRC</label>
                                                            <select class="form-control" id="trc_id" name="trc_id"
                                                                required>
                                                                <option selected value="{{ $detail->idAdmin }}" hidden>
                                                                    {{ $detail->fullName }}</option>
                                                                @foreach ($getTrc as $trc)
